Meteor.methods({
	sendFlagEmail: function(flag) {
		...
		Meteor.http.post("http://login.emorybubble.com/sendFlagEmail",//http://httpbin.org/post",
			{"data": retVal},
			function(err, res) {
				console.log(res);
			}
	...
	sendWelcomeEmail: function(userId) {
		...
		Meteor.http.post("http://localhost:3000/sendWelcomeEmail",//http://httpbin.org/post",
			{"data": retVal},
			function(err, res) {
				console.log(res);
			}
	...
	sendInvitedEmail: function(currentUserId, userId, bubbleId) {
		...
		Meteor.http.post("http://login.emorybubble.com/sendInvitedEmail",//http://httpbin.org/post",
			{"data": retVal},
			function(err, res) {
				console.log(res);
			}
	...
	sendApplicantEmail: function(userId, bubbleId) {
		...
		Meteor.http.post("http://login.emorybubble.com/sendApplicantEmail",//http://httpbin.org/post",
			{"data": retVal},
			function(err, res) {
				console.log(res);
			}
