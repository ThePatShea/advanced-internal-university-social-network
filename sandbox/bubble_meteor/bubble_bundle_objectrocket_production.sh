...
MONGO_URL="mongodb://bubbleproduction:F302pinpulse@iad-mongos0.objectrocket.com:15121/bubble_production" ROOT_URL="https://www.emorybubble.com/" PORT=3000 node ~/bubble_bundle/bundle/main.js
