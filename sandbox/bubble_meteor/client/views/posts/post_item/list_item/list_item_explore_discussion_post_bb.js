Template.listItemExploreDiscussionPostBB.helpers({
...
Template.listItemExploreDiscussionPostBB.events({
...
Template.listItemExploreDiscussionPostBB.created = function() {
  mto = "";
}

Template.listItemExploreDiscussionPostBB.rendered = function(){
